...
if ($_GET[module]=='store'){
  ...
  while ($r=mysql_fetch_array($sql)){
    ...
    $stok=$r['stok'];
    $tombolbeli="<a class='prod_cart' href=\"cart_aksi.php?module=keranjang&act=tambah&id=$r[id_produk]\">BELI</a>";
    ...
    echo "<div class='prod_box'>
          ...
          <div class='center_prod_box'>
             ...
             <div class='prod_price' style=''><span class='price'> <br /></span>&nbsp;<span class='price'> Rp. <b>$harga,-</b></span></div>
          </div>
 	...
 	if ($d[gambar]!=''){
		echo "<div class='prod_img3'><a href='foto_produk/$d[gambar]' rel='clearbox[gallery=Koleksi Produk]' title='$d[nama_produk]'<img src='foto_produk/$d[gambar]' width=180  class='tooltip' title='klik untuk memperbesar gambar' border='0' rel='clearbox[gallery=Koleksi Produk]' title='$d[nama_produk]'/></a>
            ...
            <div class='details'>$d[deskripsi]</div><br />
                    ...
                    <a href='cart_aksi.php?module=keranjang&act=tambah&id=$d[id_produk]' class='more'><img src='asset/images/beli.jpg' alt='' title='' border='0' /></a>
                    <div class='clear'></div>
                    </div>
...
elseif ($_GET[module]=='keranjangbelanja'){
  ...
  if($ketemu < 1){
    ...
    echo "<h4 class='heading colr'>Keranjang Belanja</h4>
          <form method=post action=cart_aksi.php?module=keranjang&act=update>
          ...
          <tbody>
         <tr  background='asset/images/bg_tab.jpg' align=center height=23><th><span class='table'>No</th><th><span class='table'>Produk</th><th><span class='table'>Nama Produk</th><th><span class='table'>Berat(Kg)</th><th><span class='table'>Qty</th>
  ...
  while($r=mysql_fetch_array($sql)){
    ...
    $harga       = format_rupiah($r[harga]);
       ...
       echo "<tr background='asset/images/bg_tab2.jpg'  align=center><td><span class='table2'>$no</td><input type=hidden name=id[$no] value=$r[id_orders_temp]>
              ...
              <td align=center><a href='cart_aksi.php?module=keranjang&act=hapus&id=$r[id_orders_temp]'><img src=asset/images/kali.png border=0 title=Hapus></a></td>
          </tr>";
    $no++;
  }
  echo "<tr><td colspan=6 align=right><br><span class='table3'>Total:</td><td colspan=2><br><span class='table3'>Rp. $total_rp,-</b></td></tr>
        ...
        <td colspan=4 align=right><br /><a href='selesai-pesan.html'><input style='width: 115px; height: 22px;' type=submit  class= simplebtn value='SELESAI BELANJA'><br /></td></tr>
        </tbody>
  </table>";
...
mail("joko.purwanto18@gmail.com",$subjek,$pesan,$dari);
